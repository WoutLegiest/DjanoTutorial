...
class TutorialCategory(models.Model):
    ...
    # URL that we want to point to this category
...
class TutorialSeries(models.Model):
    ...
    # This name will be displayed in the admin view, under the "MAIN" bar, where normally
    # it automatically use the name of the class
    class Meta:
...
# Hase to stand after TutorialSeries
